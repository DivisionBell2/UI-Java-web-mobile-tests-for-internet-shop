...
public class test003CheckSearchByHalfBrandName extends MainClass {
    ...
    @Test
    void test003CheckSearchByHalfBrandName() {
        mainPage
        ...
        brandName = brandName.substring(brandName.length() / 2);
